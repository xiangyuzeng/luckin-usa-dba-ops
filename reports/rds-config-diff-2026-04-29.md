...
| Network | `DBSubnetGroupName` | 2 | `rds-group` | 87% | ⚠️ 1 个离群 |
| Network | `SubnetAvailabilityZones` | 2 | `us-east-1a,us-east-1b` | 87% | ⚠️ 1 个离群 |
| Network | `Port` | 3 | `3306` | 83% | ⚠️ 2 个离群 |
| Network | `PubliclyAccessible` | 1 | `False` | 100% | 一致 |
| Network | `MultiAZ` | 2 | `True` | 87% | ⚠️ 1 个离群 |
| Network | `AvailabilityZone` | 3 | `us-east-1a` | 54% | ❌ 分散（3 种取值） |
...
| Security | `DeletionProtection` | 2 | `True` | 83% | ⚠️ 1 个离群 |
...
| Backup | `CopyTagsToSnapshot` | 2 | `True` | 87% | ⚠️ 1 个离群 |
| Backup | `PreferredBackupWindow` | 64 | `00:00-00:30` | 16% | ❌ 分散（64 种取值） |
| Backup | `PreferredMaintenanceWindow` | 80 | `wed:08:06-wed:08:36` | 2% | ❌ 分散（80 种取值） |
| Monitoring | `PerformanceInsightsEnabled` | 2 | `False` | 93% | ⚠️ 1 个离群 |
| Monitoring | `PerformanceInsightsKMSKeyId` | 2 | `(unset)` | 93% | ⚠️ 1 个离群 |
| Monitoring | `MonitoringInterval` | 1 | `0` | 100% | 一致 |
| Monitoring | `EnabledCloudwatchLogsExports` | 2 | `slowquery` | 79% | ⚠️ 1 个离群 |
| Engine | `Engine` | 3 | `mysql` | 83% | ⚠️ 2 个离群 |
| Engine | `EngineVersion` | 10 | `8.0.40` | 62% | ❌ 分散（10 种取值） |
| Engine | `DBParameterGroup` | 7 | `luckyus-prod-80-new` | 76% | ⚠️ 6 个离群 |
| Engine | `OptionGroup` | 5 | `default:mysql-8-0` | 82% | ⚠️ 4 个离群 |
| Engine | `DBInstanceClass` | 10 | `db.t4g.micro` | 48% | ❌ 分散（10 种取值） |
| Engine | `StorageType` | 3 | `gp3` | 82% | ⚠️ 2 个离群 |
...
_多数派 (77 个): `rds-group`_

- 离群值 **`docdb-group`** (12 个): `docdb-devops`, `docdb-devops2`, `docdb-devops3`, `docdb-gia`, `docdb-gia2`, `docdb-gia3`, `docdb-iot`, `docdb-iot2`, `docdb-iot3`, `docdb-luckyus-iluckychaindep`, `docdb-luckyus-iluckychaindep2`, `docdb-luckyus-iluckychaindep3`

#### `SubnetAvailabilityZones`

_多数派 (77 个): `us-east-1a,us-east-1b`_

- 离群值 **`us-east-1a,us-east-1b,us-east-1c`** (12 个): `docdb-devops`, `docdb-devops2`, `docdb-devops3`, `docdb-gia`, `docdb-gia2`, `docdb-gia3`, `docdb-iot`, `docdb-iot2`, `docdb-iot3`, `docdb-luckyus-iluckychaindep`, `docdb-luckyus-iluckychaindep2`, `docdb-luckyus-iluckychaindep3`

#### `Port`

_多数派 (74 个): `3306`_

- 离群值 **`27017`** (12 个): `docdb-devops`, `docdb-devops2`, `docdb-devops3`, `docdb-gia`, `docdb-gia2`, `docdb-gia3`, `docdb-iot`, `docdb-iot2`, `docdb-iot3`, `docdb-luckyus-iluckychaindep`, `docdb-luckyus-iluckychaindep2`, `docdb-luckyus-iluckychaindep3`
- 离群值 **`5432`** (3 个): `aws-luckyus-difynew-rw`, `aws-luckyus-dify-rw`, `aws-luckyus-pgilkmap-rw`

#### `MultiAZ`

_多数派 (77 个): `True`_

- 离群值 **`False`** (12 个): `docdb-devops`, `docdb-devops2`, `docdb-devops3`, `docdb-gia`, `docdb-gia2`, `docdb-gia3`, `docdb-iot`, `docdb-iot2`, `docdb-iot3`, `docdb-luckyus-iluckychaindep`, `docdb-luckyus-iluckychaindep2`, `docdb-luckyus-iluckychaindep3`

#### `AvailabilityZone`

_无清晰多数派，所有取值分布如下：_

- **`us-east-1a`** (48 个): `aws-luckyus-datalink-84test-rw`, `aws-luckyus-dbatest-rw`, `aws-luckyus-difynew-rw`, `aws-luckyus-dify-rw`, `aws-luckyus-fichargecontrol-rw`, `aws-luckyus-fitax-rw`, `aws-luckyus-framework01-rw-old1`, `aws-luckyus-framework02-rw`, `aws-luckyus-framework02-rw-old1`, `aws-luckyus-ibizconfigcenter-rw` ...+38
- **`us-east-1b`** (37 个): `aws-luckyus-cdpactivity-rw`, `aws-luckyus-devops-rw`, `aws-luckyus-devops-rw-old1`, `aws-luckyus-framework01-rw`, `aws-luckyus-iadmin-rw`, `aws-luckyus-ibillingcentersrv-rw`, `aws-luckyus-icyberdata-rw`, `aws-luckyus-icyberdata-rw-old1`, `aws-luckyus-iehr-rw`, `aws-luckyus-ifiaccounting-rw` ...+27
- **`us-east-1c`** (4 个): `docdb-devops3`, `docdb-gia2`, `docdb-iot2`, `docdb-luckyus-iluckychaindep3`
...
- 离群值 **`False`** (15 个): `aws-luckyus-difynew-rw`, `aws-luckyus-dify-rw`, `dbatest-xiangyuzeng`, `docdb-devops`, `docdb-devops2`, `docdb-devops3`, `docdb-gia`, `docdb-gia2`, `docdb-gia3`, `docdb-iot`, `docdb-iot2`, `docdb-iot3`, `docdb-luckyus-iluckychaindep`, `docdb-luckyus-iluckychaindep2`, `docdb-luckyus-iluckychaindep3`
...
- **`00:00-00:30`** (14 个): `aws-luckyus-ybwtest8040-rw`, `aws-luckyus-ybwtest8040-rw-green-ldlylo`, `docdb-devops`, `docdb-devops2`, `docdb-devops3`, `docdb-gia`, `docdb-gia2`, `docdb-gia3`, `docdb-iot`, `docdb-iot2` ...+4
...
- **`06:31-07:01`** (1 个): `aws-luckyus-difynew-rw`
- **`05:05-05:35`** (1 个): `aws-luckyus-dify-rw`
...
- **`08:40-09:10`** (1 个): `aws-luckyus-pgilkmap-rw`
...
- **`fri:07:44-fri:08:14`** (1 个): `aws-luckyus-difynew-rw`
- **`thu:08:11-thu:08:41`** (1 个): `aws-luckyus-dify-rw`
...
- **`sat:10:00-sat:10:30`** (1 个): `aws-luckyus-pgilkmap-rw`
...
- **`sat:03:53-sat:04:23`** (1 个): `docdb-devops`
- **`fri:05:51-fri:06:21`** (1 个): `docdb-devops2`
- **`fri:08:58-fri:09:28`** (1 个): `docdb-devops3`
- **`mon:03:23-mon:03:53`** (1 个): `docdb-gia`
- **`fri:06:51-fri:07:21`** (1 个): `docdb-gia2`
- **`thu:04:01-thu:04:31`** (1 个): `docdb-gia3`
- **`thu:09:42-thu:10:12`** (1 个): `docdb-iot`
- **`sun:05:59-sun:06:29`** (1 个): `docdb-iot2`
- **`mon:06:08-mon:06:38`** (1 个): `docdb-iot3`
- **`sun:04:52-sun:05:22`** (1 个): `docdb-luckyus-iluckychaindep`
- **`sun:03:09-sun:03:39`** (1 个): `docdb-luckyus-iluckychaindep2`
- **`thu:07:44-thu:08:14`** (1 个): `docdb-luckyus-iluckychaindep3`
...
- 离群值 **`True`** (6 个): `aws-luckyus-difynew-rw`, `aws-luckyus-dify-rw`, `aws-luckyus-icyberdata-rw`, `aws-luckyus-icyberdata-rw-old1`, `aws-luckyus-pgilkmap-rw`, `aws-luckyus-salesmarketing-rw`

#### `PerformanceInsightsKMSKeyId`

_多数派 (83 个): `(unset)`_

- 离群值 **`arn:aws:kms:us-east-1:257394478466:key/5c5c743d-b79f-4d3a-867f-5e849ee4b52b`** (6 个): `aws-luckyus-difynew-rw`, `aws-luckyus-dify-rw`, `aws-luckyus-icyberdata-rw`, `aws-luckyus-icyberdata-rw-old1`, `aws-luckyus-pgilkmap-rw`, `aws-luckyus-salesmarketing-rw`

#### `EnabledCloudwatchLogsExports`

_多数派 (70 个): `slowquery`_

- 离群值 **`(unset)`** (19 个): `aws-luckyus-datalink-84test-rw`, `aws-luckyus-dbatest-rw`, `aws-luckyus-difynew-rw`, `aws-luckyus-dify-rw`, `aws-luckyus-isalescouponservice-rw`, `aws-luckyus-pgilkmap-rw`, `dbatest-xiangyuzeng`, `docdb-devops`, `docdb-devops2`, `docdb-devops3`, `docdb-gia`, `docdb-gia2`, `docdb-gia3`, `docdb-iot`, `docdb-iot2`, `docdb-iot3`, `docdb-luckyus-iluckychaindep`, `docdb-luckyus-iluckychaindep2`, `docdb-luckyus-iluckychaindep3`
...
- 离群值 **`docdb`** (12 个): `docdb-devops`, `docdb-devops2`, `docdb-devops3`, `docdb-gia`, `docdb-gia2`, `docdb-gia3`, `docdb-iot`, `docdb-iot2`, `docdb-iot3`, `docdb-luckyus-iluckychaindep`, `docdb-luckyus-iluckychaindep2`, `docdb-luckyus-iluckychaindep3`
- 离群值 **`postgres`** (3 个): `aws-luckyus-difynew-rw`, `aws-luckyus-dify-rw`, `aws-luckyus-pgilkmap-rw`

#### `EngineVersion`

_无清晰多数派，所有取值分布如下：_

- **`8.0.40`** (55 个): `aws-luckyus-cdpactivity-rw`, `aws-luckyus-devops-rw-old1`, `aws-luckyus-fichargecontrol-rw`, `aws-luckyus-fitax-rw`, `aws-luckyus-framework01-rw-old1`, `aws-luckyus-framework02-rw-old1`, `aws-luckyus-iadmin-rw`, `aws-luckyus-ibillingcentersrv-rw`, `aws-luckyus-ibizconfigcenter-rw`, `aws-luckyus-icyberdata-rw-old1` ...+45
- **`8.0.45`** (15 个): `aws-luckyus-dbatest-rw`, `aws-luckyus-devops-rw`, `aws-luckyus-framework01-rw`, `aws-luckyus-framework02-rw`, `aws-luckyus-icyberdata-rw`, `aws-luckyus-ijumpserver-jumpserver-rw`, `aws-luckyus-ilsopdevopsdata-rw`, `aws-luckyus-iluckydorisops-rw-green-9dk6oa`, `aws-luckyus-iluckyhealth-rw`, `aws-luckyus-iotplatform-rw-green-5kpg5j` ...+5
- **`5.0.0`** (12 个): `docdb-devops`, `docdb-devops2`, `docdb-devops3`, `docdb-gia`, `docdb-gia2`, `docdb-gia3`, `docdb-iot`, `docdb-iot2`, `docdb-iot3`, `docdb-luckyus-iluckychaindep` ...+2
- **`8.4.7`** (1 个): `aws-luckyus-datalink-84test-rw`
- **`16.10`** (1 个): `aws-luckyus-difynew-rw`
- **`16.8`** (1 个): `aws-luckyus-dify-rw`
- **`8.0.44`** (1 个): `aws-luckyus-iluckyams-rw`
- **`17.4`** (1 个): `aws-luckyus-pgilkmap-rw`
- **`8.0.42`** (1 个): `aws-luckyus-ybwtest8040-rw`
- **`8.0.43`** (1 个): `aws-luckyus-ybwtest8040-rw-green-ldlylo`

#### `DBParameterGroup`

_多数派 (68 个): `luckyus-prod-80-new`_

- 离群值 **`default.docdb5.0`** (12 个): `docdb-devops`, `docdb-devops2`, `docdb-devops3`, `docdb-gia`, `docdb-gia2`, `docdb-gia3`, `docdb-iot`, `docdb-iot2`, `docdb-iot3`, `docdb-luckyus-iluckychaindep`, `docdb-luckyus-iluckychaindep2`, `docdb-luckyus-iluckychaindep3`
- 离群值 **`luckyus-prod`** (4 个): `aws-luckyus-devops-rw`, `aws-luckyus-devops-rw-old1`, `aws-luckyus-ldas-rw`, `aws-luckyus-ldas-rw-old1`
- 离群值 **`default.postgres16`** (2 个): `aws-luckyus-difynew-rw`, `aws-luckyus-dify-rw`
- 离群值 **`luckyus-prod-84-lctn0`** (1 个): `aws-luckyus-datalink-84test-rw`
- 离群值 **`default.postgres17`** (1 个): `aws-luckyus-pgilkmap-rw`
...
- 离群值 **`default:docdb-5-0`** (12 个): `docdb-devops`, `docdb-devops2`, `docdb-devops3`, `docdb-gia`, `docdb-gia2`, `docdb-gia3`, `docdb-iot`, `docdb-iot2`, `docdb-iot3`, `docdb-luckyus-iluckychaindep`, `docdb-luckyus-iluckychaindep2`, `docdb-luckyus-iluckychaindep3`
- 离群值 **`default:postgres-16`** (2 个): `aws-luckyus-difynew-rw`, `aws-luckyus-dify-rw`
- 离群值 **`default:mysql-8-4`** (1 个): `aws-luckyus-datalink-84test-rw`
- 离群值 **`default:postgres-17`** (1 个): `aws-luckyus-pgilkmap-rw`
...
- **`db.t4g.medium`** (24 个): `aws-luckyus-cdpactivity-rw`, `aws-luckyus-devops-rw`, `aws-luckyus-devops-rw-old1`, `aws-luckyus-framework01-rw`, `aws-luckyus-framework01-rw-old1`, `aws-luckyus-framework02-rw`, `aws-luckyus-framework02-rw-old1`, `aws-luckyus-icyberdata-rw`, `aws-luckyus-icyberdata-rw-old1`, `aws-luckyus-iotplatform-rw` ...+14
- **`db.t3.medium`** (9 个): `docdb-devops`, `docdb-devops2`, `docdb-devops3`, `docdb-iot`, `docdb-iot2`, `docdb-iot3`, `docdb-luckyus-iluckychaindep`, `docdb-luckyus-iluckychaindep2`, `docdb-luckyus-iluckychaindep3`
...
- **`db.r5.xlarge`** (2 个): `aws-luckyus-difynew-rw`, `aws-luckyus-dify-rw`
- **`db.r6g.large`** (2 个): `docdb-gia`, `docdb-gia3`
- **`db.t3.small`** (1 个): `aws-luckyus-iluckyhealth-rw`
- **`db.m5.large`** (1 个): `aws-luckyus-pgilkmap-rw`
...
- 离群值 **`standard`** (12 个): `docdb-devops`, `docdb-devops2`, `docdb-devops3`, `docdb-gia`, `docdb-gia2`, `docdb-gia3`, `docdb-iot`, `docdb-iot2`, `docdb-iot3`, `docdb-luckyus-iluckychaindep`, `docdb-luckyus-iluckychaindep2`, `docdb-luckyus-iluckychaindep3`
...
|---|---|---|---|---|---|---|---|---|---|---|---|
| docdb-devops | docdb | 5.0.0 | vpc-0dce7ca7770422d33 | docdb-group | sg-0deaa7cf7437e39c7 | False | True | False | False | 7 | rds-ca-rsa2048-g1 |
| docdb-devops2 | docdb | 5.0.0 | vpc-0dce7ca7770422d33 | docdb-group | sg-0deaa7cf7437e39c7 | False | True | False | False | 7 | rds-ca-rsa2048-g1 |
| docdb-devops3 | docdb | 5.0.0 | vpc-0dce7ca7770422d33 | docdb-group | sg-0deaa7cf7437e39c7 | False | True | False | False | 7 | rds-ca-rsa2048-g1 |
| docdb-gia | docdb | 5.0.0 | vpc-0dce7ca7770422d33 | docdb-group | sg-0deaa7cf7437e39c7 | False | True | False | False | 7 | rds-ca-rsa2048-g1 |
| docdb-gia2 | docdb | 5.0.0 | vpc-0dce7ca7770422d33 | docdb-group | sg-0deaa7cf7437e39c7 | False | True | False | False | 7 | rds-ca-rsa2048-g1 |
| docdb-gia3 | docdb | 5.0.0 | vpc-0dce7ca7770422d33 | docdb-group | sg-0deaa7cf7437e39c7 | False | True | False | False | 7 | rds-ca-rsa2048-g1 |
| docdb-iot | docdb | 5.0.0 | vpc-0dce7ca7770422d33 | docdb-group | sg-0deaa7cf7437e39c7 | False | True | False | False | 7 | rds-ca-rsa2048-g1 |
| docdb-iot2 | docdb | 5.0.0 | vpc-0dce7ca7770422d33 | docdb-group | sg-0deaa7cf7437e39c7 | False | True | False | False | 7 | rds-ca-rsa2048-g1 |
| docdb-iot3 | docdb | 5.0.0 | vpc-0dce7ca7770422d33 | docdb-group | sg-0deaa7cf7437e39c7 | False | True | False | False | 7 | rds-ca-rsa2048-g1 |
| docdb-luckyus-iluckychaindep | docdb | 5.0.0 | vpc-0dce7ca7770422d33 | docdb-group | sg-0deaa7cf7437e39c7 | False | True | False | False | 7 | rds-ca-rsa2048-g1 |
| docdb-luckyus-iluckychaindep2 | docdb | 5.0.0 | vpc-0dce7ca7770422d33 | docdb-group | sg-0deaa7cf7437e39c7 | False | True | False | False | 7 | rds-ca-rsa2048-g1 |
| docdb-luckyus-iluckychaindep3 | docdb | 5.0.0 | vpc-0dce7ca7770422d33 | docdb-group | sg-0deaa7cf7437e39c7 | False | True | False | False | 7 | rds-ca-rsa2048-g1 |
...
| aws-luckyus-dify-rw | postgres | 16.8 | vpc-0dce7ca7770422d33 | rds-group | sg-0deaa7cf7437e39c7 | False | True | True | False | 7 | rds-ca-rsa2048-g1 |
| aws-luckyus-difynew-rw | postgres | 16.10 | vpc-0dce7ca7770422d33 | rds-group | sg-0deaa7cf7437e39c7 | False | True | True | False | 7 | rds-ca-rsa2048-g1 |
| aws-luckyus-pgilkmap-rw | postgres | 17.4 | vpc-0dce7ca7770422d33 | rds-group | sg-0deaa7cf7437e39c7 | False | True | True | True | 7 | rds-ca-rsa2048-g1 |
